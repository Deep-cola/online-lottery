...
import com.cola.config.interceptor.LoginInterceptor;
import com.cola.config.web.RequestResponseBodyMethodProcessorWrapper;
...
public class AppConfig implements WebMvcConfigurer, InitializingBean {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(new LoginInterceptor(objectMapper))
                ...
                .addPathPatterns("/api/**")
                .excludePathPatterns("/api/user/login")//后端开放的资源: 登录
                .excludePathPatterns("/api/user/register")//后端开放的资源: 注册
